...
# To verify, you can run the following after restarting the program:
# result_temp = Runner.run_sync(agent, "What is my favorite color?", session=temp_session)
# result_persistent = Runner.run_sync(agent, "What is my favorite color?", session=persistent_session)
# print("Temp Session:", result_temp.final_output)  # Likely forgets
# print("Persistent Session:", result_persistent.final_output)  # Should say "blue"