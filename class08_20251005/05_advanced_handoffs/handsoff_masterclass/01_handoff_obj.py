...
from agents import Agent, Runner, AsyncOpenAI, OpenAIChatCompletionsModel, function_tool, handoff, set_tracing_disabled, RunContextWrapper
...
def on_news_transfer(ctx: RunContextWrapper) -> None:
    print(f"\nTransferring to NewsAgent for news updates.")
...
weather_agent: Agent = Agent(
    ...
    model=llm_model,
    tools=[get_weather],
    handoffs=[handoff(agent=news_agent, on_handoff=on_news_transfer)]
)
